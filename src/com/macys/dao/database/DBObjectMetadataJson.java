...
import com.macys.dao.database.pk.DBObjectMetadataJsonPK;
import com.macys.domain.business.common.BusinessObjectTypeEnum;

@Entity
@Table(name = "dbobject_metadata_json")
@NamedQuery(name="DBObjectMetadataJson.findByPK", query="from DBObjectMetadataJson o where o.pk = ?1")
public class DBObjectMetadataJson extends DBAbstractBase {
...
//	private Integer counter;
	...
	@EmbeddedId
	private DBObjectMetadataJsonPK pk;
	...
	public DBObjectMetadataJson() {
		this(null);
		this.createdOn = new Date();
	}
	
	public DBObjectMetadataJson(DBObjectMetadataJsonPK id) {
		this.pk = id;
		this.type = clipTypeFromUuid();
		this.createdOn = new Date();
	}
	
	public DBObjectMetadataJson(DBObjectMetadataJsonPK id, String value, String createdBy) {
		this.pk = id;
		this.value = value;
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof DBObjectMetadataJson) {
			DBObjectMetadataJson that = (DBObjectMetadataJson) obj;
	...
	public DBObjectMetadataJsonPK getPk() {
		return pk;
	}

	public void setPk(DBObjectMetadataJsonPK pk) {
		this.pk = pk;
	}
